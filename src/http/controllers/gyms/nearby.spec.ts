...
describe('Nearby Gyms (e2e)', () => {
  ...
  it('should be able list nearby gyms', async () => {
    // Qualquer usuário autenticado pode buscar por academias próximas, porém como está sendo criado uma academia abaixo, o usuário precisa ter a função ADMIN
    ...
    // Solicitação HTTP para a aplicação (buscar academias próximas ao usuário)
...
exemplo, para buscar academias próximas ao usuário é necessário que o usuário esteja registrado e autenticado. Ou seja, tanto o código para simular o registro 
de usuários como o código para simular o login de usuários devem estar dentro do teste de busca de academias próximas. No caso, o código referente a criação e 
autenticação de usuário está implementado na função createAndAuthenticateUser.
*/
