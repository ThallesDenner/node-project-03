...
describe('Check-in History (e2e)', () => {
  ...
  it('should be able to list the history of check-ins', async () => {
    ...
    // Solicitação HTTP para a aplicação (buscar histórico de check-ins)
    ...
    // Verifica se checkIns é um array que possui dois objetos, cada objeto contendo seu respectivo gymId e userId
